...
mavlink.MAV_SYS_STATUS_SENSOR_ENUM_END = 67108865 // 
...
Deprecated. Use BATTERY_STATUS instead. 2nd Battery status
                ...
                current_battery           : Battery current, in centiamperes (1 = 10 milliampere), -1: autopilot does not measure the current (int16_t)
...
Deepstall path planning
                ...
                landing_lat               : Landing latitude (deg * 1E7) (int32_t)
                landing_lon               : Landing longitude (deg * 1E7) (int32_t)
                path_lat                  : Final heading start point, latitude (deg * 1E7) (int32_t)
                path_lon                  : Final heading start point, longitude (deg * 1E7) (int32_t)
                arc_entry_lat             : Arc entry point, latitude (deg * 1E7) (int32_t)
                arc_entry_lon             : Arc entry point, longitude (deg * 1E7) (int32_t)
                altitude                  : Altitude (meters) (float)
                expected_travel_distance        : Distance the aircraft expects to travel during the deepstall (float)
                cross_track_error         : Deepstall cross track error in meters (only valid when in DEEPSTALL_STAGE_LAND) (float)
                stage                     : Deepstall stage, see enum MAV_DEEPSTALL_STAGE (uint8_t)
